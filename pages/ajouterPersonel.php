<?php 
    ...
    $requet=  "SELECT * FROM Personel INNER JOIN Personel_Domaine_competence ON Personel.id_personel = Personel_Domaine_competence.personel_id INNER JOIN Domaine_competence ON Personel_Domaine_competence.domaine_competence_id = Domaine_competence.id_domaine_competence";
                ...
                <div class="card-body">
                    <form method="POST" action="insertPersonel.php" class="form">
                        ...
                        <div id="validation_texte">
                            <p><button type="submit" name="envoi" class="btn btn-success mt-2"><span class="fa fa-save"></span>
